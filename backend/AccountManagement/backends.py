...
class UserBackend:
    ...
    def authenticate(self, request, user_id: str = '', name: str = '', discriminator: str = '', avatar: str = '') -> Optional[User]:
        user = None
        try:
            ...
            user = User.objects.create_user(user_id, name, discriminator, avatar)
    ...
    def get_user(self, user_id) -> Optional[UserModel]:
        try:
            user = User.objects.get(user_id=user_id)
        except User.DoesNotExist:
            return None
